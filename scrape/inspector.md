...
2. Right click on the first heading, which should say "2023 anti-trans bills tracker"
...
Just as a refresher, I'm going to examine a sample HyperText Markup Language (HTML) file. An HTML file tells the computer how to layout the web page. 
